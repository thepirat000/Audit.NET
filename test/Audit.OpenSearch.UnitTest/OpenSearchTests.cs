...
namespace Audit.OpenSearch.UnitTest
{
    public class OpenSearchTests
    {
        ...
        {
            var dataProvider = new OpenSearchDataProvider(new OpenSearchClient(new Uri(TestCommon.OpenSearchUrl)));
        ...
        {
            var dataProvider = new OpenSearchDataProvider(c => c.Client(new ConnectionSettings(new Uri(TestCommon.OpenSearchUrl))));
            var indexName = "auditevent_order";
        ...
        {
            var dataProvider = new OpenSearchDataProvider(c => c.Client(new OpenSearchClient(new ConnectionSettings(new Uri(TestCommon.OpenSearchUrl)))));
        ...
        {
            var dataProvider = new OpenSearchDataProvider(c => c.Client(new Uri(TestCommon.OpenSearchUrl)));
            var indexName = "auto_" + new Random().Next(10000, 99999);
        ...
        {
            var indexName = "auto_" + new Random().Next(10000, 99999);
            var dp = new OpenSearchDataProvider(c => c.Client(new Uri(TestCommon.OpenSearchUrl)).Index(indexName));
