...
SELECT EventId, 
	...
	JSON_VALUE(Data, '$.Exception') As [Exception],
	JSON_VALUE(Data, '$.MachineName') AS [MachineName],
	CAST(JSON_VALUE(Data, '$.UserName') AS NVARCHAR(50)) AS [UserName],
	JSON_VALUE(Data, '$.CallingMethodName') AS [CallingMethodName],
	CAST(JSON_VALUE(Data, '$.CreatedDate') AS NVARCHAR(35)) AS [CreatedDate],
	CAST(JSON_VALUE(Data, '$.CommitDate') AS NVARCHAR(35)) As [CommitDate],
