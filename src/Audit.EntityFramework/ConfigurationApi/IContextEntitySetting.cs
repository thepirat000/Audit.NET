...
namespace Audit.EntityFramework.ConfigurationApi
{
    ...
    public interface IContextEntitySetting<TEntity>
    {
        ...
        /// <summary>
        /// Overrides a column value using a callback that receives the entity entry and override context.
        /// </summary>
        /// <typeparam name="TProp">The property type</typeparam>
        /// <param name="property">The property selector. Must be a simple property expression i.e. x -> x.PropertyName</param>
        /// <param name="valueSelector">A function of the entity entry and <see cref="PropertyOverrideContext"/> that returns the value to store on the audit trail</param>
        IContextEntitySetting<TEntity> Override<TProp>(Expression<Func<TEntity, TProp>> property, Func<EntityEntry, PropertyOverrideContext, object> valueSelector);

        /// <summary>
        /// Overrides a column value using a callback that receives the entity entry.
        /// </summary>
        /// <typeparam name="TProp">The property type</typeparam>
        /// <param name="property">The property selector. Must be a simple property expression i.e. x -> x.PropertyName</param>
        /// <param name="valueSelector">A function of the entity entry that returns the value to store on the audit trail</param>
        ...
        /// <param name="propertyName">The entity's property name (case-sensitive)</param>
        /// <param name="valueSelector">A function of the entity entry and <see cref="PropertyOverrideContext"/> that returns the value to store on the audit trail</param>
        IContextEntitySetting<TEntity> Override(string propertyName, Func<EntityEntry, PropertyOverrideContext, object> valueSelector);
