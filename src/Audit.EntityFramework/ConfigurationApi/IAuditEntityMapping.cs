...
namespace Audit.EntityFramework.ConfigurationApi
{
    ...
    public interface IAuditEntityMapping
    {
        ...
        /// Maps the entity type specified on <typeparamref name="TSourceEntity"/> to the audit entity type specified on <typeparamref name="TAuditEntity"/>
        /// </summary>
        /// <param name="entityAsyncAction">An asynchronous action to perform on the audit entity of type <typeparamref name="TAuditEntity"/> before saving it</param>
        /// <typeparam name="TSourceEntity">The entity type to be audited</typeparam>
        /// <typeparam name="TAuditEntity">The entity type that holds the audit of the type audited</typeparam>
        IAuditEntityMapping Map<TSourceEntity, TAuditEntity>(Func<AuditEvent, EventEntry, TAuditEntity, Task> entityAsyncAction);
        ...
        /// Maps the entity type specified on <typeparamref name="TSourceEntity"/> to the audit entity type specified on <typeparamref name="TAuditEntity"/>
        /// </summary>
        /// <param name="entityAsyncAction">An asynchronous action to perform on the audit entity of type <typeparamref name="TAuditEntity"/> before saving it. 
        /// Must return a boolean indicating whether to include the entity on the audit logs.</param>
        /// <typeparam name="TSourceEntity">The entity type to be audited</typeparam>
        /// <typeparam name="TAuditEntity">The entity type that holds the audit of the type audited</typeparam>
        IAuditEntityMapping Map<TSourceEntity, TAuditEntity>(Func<AuditEvent, EventEntry, TAuditEntity, Task<bool>> entityAsyncAction);
        ...
        /// <typeparam name="TSourceEntity">The entity type to be audited</typeparam>
        /// <typeparam name="TAuditEntity">The entity type that holds the audit of the type audited</typeparam>
        IAuditEntityMapping Map<TSourceEntity, TAuditEntity>(Func<TSourceEntity, TAuditEntity, Task> entityAsyncAction);
        ...
        /// <typeparam name="TSourceEntity">The entity type to be audited</typeparam>
        /// <typeparam name="TAuditEntity">The entity type that holds the audit of the type audited</typeparam>
        IAuditEntityMapping Map<TSourceEntity, TAuditEntity>(Func<TSourceEntity, TAuditEntity, Task<bool>> entityAsyncAction);
        ...
        /// </summary>
        /// <param name="mapper">The mapper function that takes the event entry information and returns the audit entity type</param>
        /// <param name="entityAsyncAction">An asynchronous action to perform on the audit entity before saving it. Return true to include the entity, or false otherwise.</param>
        /// <typeparam name="TSourceEntity">The entity type to be audited</typeparam>
        IAuditEntityMapping Map<TSourceEntity>(Func<EventEntry, Type> mapper, Func<AuditEvent, EventEntry, object, Task<bool>> entityAsyncAction);
        ...
        /// </summary>
        /// <param name="mapper">The mapper function that takes the event entry information and returns the audit entity type</param>
        /// <param name="entityAsyncAction">An asynchronous action to perform on the audit entity before saving it</param>
        /// <typeparam name="TSourceEntity">The entity type to be audited</typeparam>
        IAuditEntityMapping Map<TSourceEntity>(Func<EventEntry, Type> mapper, Func<AuditEvent, EventEntry, object, Task> entityAsyncAction);
        ...
        /// <summary>
        /// Maps an entry that matches a given <paramref name="predicate"/>, to the given audit type <typeparamref name="TAuditEntity"/> 
        /// and executes the <paramref name="entityAsyncAction"/> on the created audit entity.
        /// Useful for entities that are not mapped to a type (i.e. implicitly created join tables)
        /// </summary>
        /// <param name="predicate">A function to test the Event Entries for a condition. Return true</param>
        /// <param name="entityAsyncAction">An asynchronous action to perform on the audit entity before saving it</param>
        /// <typeparam name="TAuditEntity">The entity type that holds the audit of the type audited</typeparam>
        IAuditEntityMapping MapExplicit<TAuditEntity>(Func<EventEntry, bool> predicate, Func<EventEntry, TAuditEntity, Task> entityAsyncAction = null);
        ...
        /// <param name="entityAsyncAction">An asynchronous action to perform on the audit entity before saving it</param>
        /// <typeparam name="TAuditEntity">The entity type that holds the audit of the type audited</typeparam>
        IAuditEntityMapping MapTable<TAuditEntity>(string tableName, Func<EventEntry, TAuditEntity, Task> entityAsyncAction = null);
        ...
        /// <summary>
        /// Defines a common asynchronous action to perform to all the audit entities before saving. 
        /// </summary>
        /// <param name="entityAsyncAction">A default action to perform on the audit entity before saving it</param>
        void AuditEntityAction(Func<AuditEvent, EventEntry, object, Task> entityAsyncAction);

        /// <summary>
        /// Defines a common asynchronous action to perform to all the audit entities before saving. 
        /// </summary>
        /// <param name="entityAsyncAction">A default async action to perform on the audit entity before saving it
        /// Must return a boolean indicating whether to include the entity on the audit logs.</param>
        void AuditEntityAction(Func<AuditEvent, EventEntry, object, Task<bool>> entityAsyncAction);
        ...
        /// <param name="entityAsyncAction">A default action to perform on the audit entity before saving it</param>
        /// <typeparam name="T">The audit entity type</typeparam>
        void AuditEntityAction<T>(Func<AuditEvent, EventEntry, T, Task> entityAsyncAction);
        ...
        /// Must return a boolean indicating whether to include the entity on the audit logs.</param>
        /// <typeparam name="T">The audit entity type</typeparam>
        void AuditEntityAction<T>(Func<AuditEvent, EventEntry, T, Task<bool>> entityAsyncAction);
    }
}
