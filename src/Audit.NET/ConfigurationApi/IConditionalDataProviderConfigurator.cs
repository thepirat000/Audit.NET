...
namespace Audit.Core.ConfigurationApi
{
    ...
    public interface IConditionalDataProviderConfigurator
    {
        ...
        IConditionalDataProviderConfigurator When(Func<AuditEvent, bool> guardCondition, Func<AuditEvent, IAuditDataProvider> dataProviderFactory);
        ...
        IConditionalDataProviderConfigurator When(Func<AuditEvent, bool> guardCondition, Func<IAuditDataProvider> dataProviderInitializer);
        ...
        IConditionalDataProviderConfigurator When(Func<AuditEvent, bool> guardCondition, IAuditDataProvider dataProvider);
        ...
        void Otherwise(Func<AuditEvent, IAuditDataProvider> dataProviderFactory);
        ...
        void Otherwise(Func<IAuditDataProvider> dataProviderInitializer);
        ...
        void Otherwise(IAuditDataProvider dataProvider);
    }
}